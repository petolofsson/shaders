...
**Stage 2 — Tonal (87% novel)**
Novel: Oklab-stable L-substitution (R62), intra-zone pixel variance driver (R116), temporal context ratio (R60), ambient shadow tint (R66), fine-texture shadow gate (R119). Drag: Retinex (Land & McCann 1971) and zone system (Adams 1940s) carry real visual weight despite the novel implementation details.
