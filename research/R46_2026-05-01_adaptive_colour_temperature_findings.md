...
| Property | Assessment |
|----------|-----------|
| Pumping on scene cuts | Prevented by Kalman EMA on warm_bias |
| Overcorrection | Clamped to ±35 correction range |
| Artistic override | HIGHLIGHT_TEMP still works as offset |
| SDR ceiling | No luminance change — temperature correction is channel redistribution |
| New pass cost | ~64 taps on 1/8-res CreativeLowFreqTex — negligible |
